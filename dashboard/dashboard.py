...
with register_col:
    try:
        if not st.session_state["authentication_status"]:
            ...
            if authenticator.register_user(location='main', fields=registration_fields):
                st.success('User registered successfully! Please log in.')
                # Update the config file to make the new user persistent
...
# If no login has been attempted yet
